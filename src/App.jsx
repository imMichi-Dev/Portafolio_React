...
function App() {
  ...
  const projects = [
    {
      ...
      tech: "HTML5 - JS - Tailwind",
      desc: "Proyecto de editor para generar memes. Esta es una plicación con la que podrás manipular el texto y la imagen de tu meme para modificar dinámicamente su contenido y sus propiedades",
      featured: false,
      link_page: "https://immichi-dev.github.io/GeneradorDeMemes-19/",
      link_github: "https://github.com/imMichi-Dev/GeneradorDeMemes-19",
    },
    {
      id: 2,
      title: "AhorrADAs",
      tech: "JS - LocalStorage - Tailwind",
      desc: "Proyecto de aplicación que permite llevar un registro de los gastos realizados y de los ingresos obtenidos.",
      featured: false,
      link_page: "https://immichi-dev.github.io/Ahorradas23/",
      link_github: "https://github.com/imMichi-Dev/Ahorradas23",
    },
    {
      id: 3,
      title: "Rick and Morty database",
      tech: "React - API Rest - JS - Tailwind",
      desc: "Proyecto de aplicación que permite listar episodios y personajes de Rick y Morty, y obtener información sobre los mismos.",
      featured: false,
    ...
    // },
    {
      ...
      tech: "React - API Rest - JS - Bootstrap",
      desc: "proyecto de aplicación que permite conectarse a una API de películas, los estrenos, populares y mejor puntadas.",
      featured: true,
      link_page: "https://react-movies-atsc.vercel.app/recientes",
      link_github: "https://github.com/imMichi-Dev/React-Movies",
    },
  ];
  ...
  return (
    <div className="App">
        ...
        <div className="row w-100">
          <div className="col-lg-8">
            ...
            <p className="lead text-secondary" style={{ maxWidth: "600px" }}>
              Desarrolladora de Software creativa, enfocada en diseño limpio y
              código eficiente. Transformo ideas complejas en interfaces
              simples.
            </p>
          </div>
        </div>
        ...
        <div className="container py-5">
          ...
          <div className="d-flex flex-wrap gap-3">
            {skills.map((skill, index) => (
              <span
                key={index}
                className="border border-secondary px-4 py-2 rounded-pill text-light"
          ...
          <div className="row g-4 justify-content-center">
            {projects.map((proj) => (
              <div key={proj.id} className="col-lg-4 col-md-6 col-sm-12">
                <div
                  className="card h-100 card-custom p-4 d-flex flex-column"
                  style={{ minHeight: "300px" }}
                  onClick={(e) => {
                    e.stopPropagation();
                    window.open(proj.link_page, '_blank');
                  }}
                >
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    <span
                      className="text-secondary"
                      style={{ fontFamily: "Antonio", fontSize: "1.5rem" }}
                    ></span>
                  </div>
                  <h3 className="h4 mt-2">{proj.title}</h3>
                  <p className=" small" style={{ opacity: 0.4 }}>
                    {proj.tech}
                  </p>
          ...
          <div className="contact-card">
            <div className="row gy-5">
              ...
              <div className="col-lg-5 pe-lg-5">
                ...
                <p
                  className="text-secondary mb-5 lead"
                  style={{ fontSize: "1rem" }}
                >
                  Estoy disponible para trabajos freelance, colaboraciones o
                  simplemente para charlar sobre código. Si tienes una idea
                  interesante, ¡hablemos!
                </p>
                <ul className="list-unstyled social-list">
                  <li>
                    <a
                      href="https://github.com/imMichi-Dev"
                      className="text-reset text-decoration-none"
                    >
                      <FaGithub className="social-icon" />{" "}
                      github.com/imMichi-Dev
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      className="text-reset text-decoration-none"
                    >
                      <FaLinkedinIn className="social-icon" /> maria jose garces
                    </a>
                  </li>
                  <li>
                    <a
                      href="mailto:mj.garcest@gmail.com"
                      className="text-reset text-decoration-none"
                    >
              ...
              <div className="col-lg-7">
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="_subject"
                    value="¡Nuevo mensaje de tu Portafolio!"
                  />
                  ...
                  <button
                    type="submit"
                    className="btn btn-light rounded-0 px-5 py-3"
      ...
      <footer
        className="text-center py-4 small border-top border-dark"
        style={{ opacity: 0.4 }}
      >
